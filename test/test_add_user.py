...
#    app.session.login(username="admin", password="secret")
    app.users.create(Users(first_name="sdf", middle_name="sdfsd", last_name="sdfsdf", nick_name="sdfsd", title="sfdsd", companyname="sdfsd", address="sdfsdf", home="sdfsdf", mobile="sdfsdf",
